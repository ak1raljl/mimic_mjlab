...
def make_tracking_env_cfg() -> ManagerBasedRlEnvCfg:
    ...
    events: dict[str, EventTermCfg] = {
        ...
        # Apply pseudo-inertia before CoM offsets: pseudo_inertia reconstructs all
        # inertial fields from their defaults and would otherwise overwrite base_com.
        "add_link_inertia": EventTermCfg(
            mode="startup",
            func=dr.pseudo_inertia,
            params={
                "asset_cfg": SceneEntityCfg("robot", body_names=()),  # Set in robot cfg.
                "alpha_range": (-0.112, 0.091),  # Approximately 0.8x to 1.2x mass.
            },
        ),
